...
1. Read .Codex/references/domain-profile.md for field conventions
2. Read strategy memo in `quality_reports/` if it exists
3. Check AGENTS.md for language preference (R/Stata/Python/Julia)
...
4. **Comparison step** — verify numerical alignment per `.Codex/references/domain-profile.md` tolerances:
